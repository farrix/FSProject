...
<body>
	<div id="navbar">
            ...
            {
                echo '<li>'.anchor('cms/profile/logout','Logout').'</li>';
                echo '<li class="menu-div"></li>';
                echo '<li>'.anchor('cms/member/profile','Profile').'</li>';
                echo '<li class="menu-div"></li>';

            } else {

                echo '<li>'.anchor('en/login','Login').'</li>';
                echo '<li class="menu-div"></li>';
                echo '<li>'.anchor('en/register','Register &amp; Benefits').'</li>';
                echo '<li class="menu-div"></li>';
            ...
            <li class="search-area">
                <?= form_open('en/search'); ?>
                    <input type="text" value="Search" name="search_field" class="search-input" />
